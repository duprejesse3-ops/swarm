...
function SearchAd({ organism, skuName }: { organism: Organism; skuName?: string }) {
  return (
    <div className="rounded-xl bg-elevated p-5 shadow-[var(--shadow-border)]">
      ...
      <p className="mt-0.5 truncate font-mono text-[11px] text-success">
    ...
    <div className="rounded-xl bg-elevated p-5 shadow-[var(--shadow-border)]">
      ...
      <dl className="mt-4 space-y-2 text-sm">
        <div className="flex justify-between gap-4 border-b border-border py-2">
          ...
          <dd className="text-right">{organism.proofHook}</dd>
        </div>
        <div className="flex justify-between gap-4 border-b border-border py-2">
          <dt className="text-muted">Job</dt>
          <dd className="max-w-[70%] text-right">{organism.body}</dd>
        </div>
